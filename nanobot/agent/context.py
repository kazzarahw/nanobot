...
## LSP Integration
File operations (read, write, edit) automatically include language server diagnostics when available.
When you see "--- LSP Diagnostics ---" after a file operation, review and fix any errors or warnings before proceeding."""
