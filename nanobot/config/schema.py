...
class LspServerConfig(BaseModel):
    ...
    command: str  # e.g. "pyright-langserver"
    ...
    diagnostic_delay: float = 1.0  # seconds to wait after change before reading diagnostics
...
class LspConfig(BaseModel):
    ...
    diagnostics_on_read: bool = True  # include diagnostics when reading files
    diagnostics_on_write: bool = True  # include diagnostics after writing/editing
